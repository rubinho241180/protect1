...
function download (url, name, events, opts) {
  ...
  xhr.onload = function () {
    saveAs(xhr.response, name, events, opts)
  }
...
var saveAs = _global.saveAs || (
  ...
  ? function saveAs (blob, name, events, opts) { globalEvents = events;
    ...
    if (typeof blob === 'string') {
      ...
      if (a.origin !== location.origin) {
        corsEnabled(a.href)
          ? download(blob, name, opts, events)
  ...
  : function saveAs (blob, name, opts, popup) { globalEvents = events;
