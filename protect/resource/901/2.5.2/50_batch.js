...
window.WAPP.sendFile2x = function(contact, imgBase64, caption, done)
{
...
window.WAPI.normalizePlus = function(id) {
    return '+' + id;
    //return ((id.substr(0,1) == '5') ? '' : '+') + id;
    //return id;
...
{ //return false;
    ...
    { 
        ...
        if (!contact.canReceiveMessage)
        {
            ...
            //console.log('checked: ' + JSON.stringify(batch));
                ...
                if (!!batch.messages.listHelper)
                {
                    batch.messages.listHelper.forEach((msg) => {
                        ...
                        if (msg.file) {
                            ...
                            WAPP.sendFile(contact.jid, msg.file.base64, {caption: fileCaption, filename: msg.file.fileName});
                        }
                    });
                }
            }
...
console.log('---=> 50_batch.js 2.5.2 sexta');