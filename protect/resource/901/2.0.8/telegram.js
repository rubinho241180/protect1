        ...
        found: function()
        {
            ...
            sendMsg(batch.messages.listHelper[idx], {
                ...
                sent: function() 
                {
                    ...
                    if (idx < batch.messages.listHelper.length-1)
                    {
                        idx++;
...
SEL_CONNECTED    = '.SearchInput';
SEL_SYNCING      = 'xxx';
SEL_DISCONNECTED = '#sign-in-phone-code';
SEL_CONFLICT     = 'xxx';
                        ...
                        console.log(JSON.stringify(
                            {
                                ...
                                formattedId: WAPP.profile.id.substring(1,50),
                            }
                        ));
...
SEL_CONNECTED    = '.SearchInput:first';
SEL_SYNCING      = 'xxx';
SEL_DISCONNECTED = '#sign-in-phone-code:first';
SEL_CONFLICT     = 'xxx';
        ...
        connected: {
            override: function()
            {
                setTimeout(function() {
                    ...
                    /*
                    WAPP.profile.id = '558199999999';//$('[ng-bind^="profile.phone"]').text();
...
$('head').append('<style type="text/css">.login_try_desktop, .tg_try_desktop {display: none;}</style>');
$('head').append('<style type="text/css">.tg_head_split, .im_page_wrap {max-width: 100%;}</style>');



console.log('telegram.js 2.0.0 INJECTED!');

                        simulateClick('[ng-click="$close()"]');

                        //try app desktop propaganda
                        //simulateClick('.try_desktop_close');
