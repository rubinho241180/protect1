const 
      ...
      ST_DISCONNECTED = 'stUnlogged' ,
      ST_SYNCING      = 'stLoggining'      ,
      ST_CONNECTED    = 'stLogged'    ,
      ...
      MONITORE_MESSAGES = false;

WAPP.triggerStatus = function()
{
    //STATUS
    var x_mode = typeof WAPP.__status().__x_mode == 'string' ? WAPP.__status().__x_mode : 'zz';
    var simpli = '';
...
WAPP.monitoringStatus = function() 
{
    ...
    setInterval(function() {
        ...
        simpli = (document.querySelectorAll('[data-icon=menu]').length > 0) ? ST_CONNECTED : ST_DISCONNECTED;

        if (simpli != WAPP.status.simplified) {
...
console.log('---=> 80_status.js 2.0.0');
