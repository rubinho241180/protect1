...
{
    JOBS.delay = ADelay;
    JOBS.sel = job.click || job.clickTry || job.waitFound || job.waitNotFound || job.writeInput || job.style || job.sendKey || job.whileFoundSendEsc || JOBS.sel;
