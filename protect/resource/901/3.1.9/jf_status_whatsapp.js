...
SEL_CONNECTED = '[aria-label*="WhatsApp"]';

SEL_DISCONNECTED = 'canvas[aria-label*="QR code"]';
                ...
                tempo = setInterval(async () => {
                    ...
                    if (!!window.WPP)
                    {
                        //try {
                            ...
                            //---------------------------------------------------- usar no kanban > let userObj = WPP.whatsapp.ContactStore.get(WPP.whatsapp.UserPrefs.getMaybeMeUser());
