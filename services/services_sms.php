                ...
                [
                    ...
                    'parameters' => [
                        'setup' => [
                            'driver=GoIP',
                            'method=GET',
                            'url=http://{host}/default/en_US/send.html?l={line}&n={to}&m={text}&u={user}&p={password}',
                            //'fields=l={line}&n={to}&m={text}',
                            //'credentials=u={user}&p={password}'

                            //'urlStatus=http://{host}/default/en_US/send_status.xml?u={user}&p={password}'

                            //http://191.6.13.160:81/default/en_US/send.html?l=1&n=81998636365&m=TESTE&u=admin&p=admin
                            //http://191.6.13.160:81/default/en_US/send_status.xml?u=admin&p=admin                            
                        ],
                        'status' => [
                            'url=http://{host}/default/en_US/send_status.xml?u={user}&p={password}',
                        ],
                        'fields' => [
                            'Host=',
                            'Line=',
